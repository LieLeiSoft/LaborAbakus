	...
	public void onResume() {
		...
		for (int x=1; x<=7; x++)															 
		{
   		...
   		for(Map.Entry<String,?> entry : keys.entrySet()){
   			...
   			if (("Netto_Brutto,NachkommastellenGehalt,NachkommastellenRSD,Einstellungen,TG_Hauptmenue,BH_Hauptmenue,TG_Molmasse,BH_Molmasse,strCounter,VerdGehaltEinheit,Auswahl," +
				...
				"Molmasse_0,Molmasse_1,Molmasse_2,Molmasse_3,Molmasse_4,Molmasse_5,Molmasse_6,Molmasse_7,Molmasse_8,Molmasse_9,Molmasse_10,Molmasse_11,Level,Highscore,Highscore1,Highscore2,Highscore3,Highscore4,Highscore5,Highscore6").indexOf(strKeyName) == -1) {
   				// Parameter entfernen
