...
public class ListActivity extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        // Build Adapter
        ListAdapter Werteadapter = new ArrayAdapter<String>(this, R.layout.listview_rsd, myItems);

        // Configure the list view
        ListView WerteListView = (ListView) findViewById(R.id.lvWerteListe);
...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView lv = (ListView) findViewById(R.id.lvWerteListe);
